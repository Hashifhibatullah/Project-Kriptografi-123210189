...
<body>
  ...
  <div class="container shadow-2-strong rounded-5 p-4">
    <div class="card-body col-lg-6 col-md-6 col-sm-12 col-xs-12">
      ...
      <br>
      <p class="card-text">1. Melihat List Data Nilai Siswa SMA IT AL-ITTIHAD: <a href="view_nilai.php">Lihat Data</a></p>
      <p class="card-text">2. Menambahkan Data Nilai Siswa SMA IT AL-ITTIHAD: <a href="form_nilai.php">Tambahkan Data</a></p>
    </div>
  </div>
